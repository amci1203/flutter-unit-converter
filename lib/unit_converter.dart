...
class _UnitConverterState extends State<UnitConverter> {
  ...
  Future<void> _updateConversion() async {
    ...
    if (widget.category.name == 'Currency') {
      val = await Api.convert(_inputValue.toString(), _fromValue.name, _toValue.name);
    } else {
      val = _format(_inputValue * _toValue.conversion / _fromValue.conversion);
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: _padding,
      child: isPortrait
      ? ListView(children: <Widget>[input, arrows, output])
      : Center(
        child: Container(
          width: 600.0,
          child: Row(
